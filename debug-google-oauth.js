...
async function debugGoogleOAuth() {
  ...
  try {
    ...
    console.log('1. Testing Google OAuth configuration...');
    ...
    if (error) {
      ...
      console.log('2. Verify Google Client ID and Secret in Supabase Auth settings');
      console.log('3. Ensure redirect URLs are configured correctly in Google Console');
    ...
    if (data?.url) {
      ...
      console.log('1. Make sure Google Cloud Console has these redirect URIs:');
